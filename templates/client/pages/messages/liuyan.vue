...
<view class="content">
	<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
		<form :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","background":"#ffffff","display":"block","height":"auto"}'>
			<view :style='{"padding":"4rpx 0 4rpx 48rpx","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
			...
			<view @tap="uploadTap" :style='{"padding":"4rpx 0 4rpx 48rpx","margin":"0 0 24rpx 0","borderColor":"#eeeeee","alignItems":"center","borderRadius":"8rpx 0 0 8rpx","borderWidth":"0 0 2rpx 0","background":"#ffffff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
			...
			<view :style='{"width":"100%","justifyContent":"center","display":"flex","height":"auto"}'>
				<button :style='{"border":"0px solid #eeeeee","padding":"0 0 0 0","margin":"0 20rpx 0 20rpx","color":"#ffffff","background":"#1D5DCA","width":"200rpx","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}' @tap="onSubmitTap" class="bg-red margin-tb-sm">提交</button>
			</view>
		</form>
	</view>
</view>
...
<script>
	export default {
		...
		async onLoad(options) {
            ...
            if(table == `yuangong`){
                this.ruleForm.username = this.user.yuangongzhanghao
            }
			this.styleChange()
		},
		methods: {
